...
const About = () => {
  ...
  {/* Card Content */}
 <div className="group relative z-20 p-4 bg-white rounded-lg shadow-md">
  <CardHeader className="text-center">
    <Target className="h-12 w-12 text-blue-600 mx-auto mb-4 group-hover:text-blue-800 transition-colors duration-300" />
    <CardTitle className="text-lg text-gray-800 group-hover:text-blue-800 transition-colors duration-300">
      Primary Objective
    </CardTitle>
  </CardHeader>
    <CardContent>
  ...
  <div className="group relative z-20 p-4 bg-white rounded-lg shadow-md">
  <CardHeader className="text-center">
    <Globe className="h-12 w-12 text-green-600 mx-auto mb-4 group-hover:text-blue-800 transition-colors duration-300" />
    <CardTitle className="text-lg text-gray-800 group-hover:text-blue-800 transition-colors duration-300">
      Scope
    </CardTitle>
  </CardHeader>
  ...
  <div className="group relative z-20 p-4 bg-white rounded-lg shadow-md">
  <CardHeader className="text-center">
    <Users className="h-12 w-12 text-blue-600 mx-auto mb-4 group-hover:text-blue-800 transition-colors duration-300" />
    <CardTitle className="text-lg text-gray-800 group-hover:text-blue-800 transition-colors duration-300">
      Stakeholders
    </CardTitle>
  </CardHeader>
 ...
 <Card className="group relative overflow-hidden text-center border-border/50 shadow-[var(--shadow-card)] transition-all duration-300 hover:scale-105 rounded-xl">
  ...
  <div className="group relative z-20 p-4 bg-white rounded-lg shadow-md">
  <CardHeader className="text-center">
    <TrendingUp className="h-15 w-12 text-blue-600 mx-auto mb-4 group-hover:text-blue-800 transition-colors duration-300" />
    <CardTitle className="text-lg text-gray-800 group-hover:text-blue-800 transition-colors duration-300">
      Impact
    </CardTitle>
  </CardHeader>
